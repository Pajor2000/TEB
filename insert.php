<?php
  ...
  if (!empty($_POST)) {
    foreach ($_POST as $key => $value) {
      if (empty($value)) {
        ...
        echo "<script>history.back()</script>";//cofa użytkownika na poprzednią stronę
        exit();
      }
    }
  ...
  header("location: ../4_db_select_table_delete_insert.php?addUser=");//sprawdzanie czy nie ma błedów
 ?>
